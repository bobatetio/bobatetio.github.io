...
(function () {
  ...
  function init() {
    ...
    for (var i = 0; i < els.length; i++) {
      ...
      /* the web app's own play mark (ukviews.js PLAY_PATH), not a hand-drawn triangle */
      btn.innerHTML = '<svg class="ukPlayMk" viewBox="0 0 44 44" aria-hidden="true">' +
        '<path fill-rule="evenodd" clip-rule="evenodd" d="' +
        'M22 0C9.85 0 0 9.85 0 22s9.85 22 22 22 22-9.85 22-22S34.15 0 22 0Z' +
